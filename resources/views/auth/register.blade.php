          ...
          <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
            ...
            <div class="col-12 my-2 justify-content-center">
                <div class="mb-1">
                  ...
                  <input type="text" class="form-control @error('name') is-invalid @enderror" id="register-username" name="username" placeholder="abdul" aria-describedby="register-username" tabindex="1" autofocus value="{{ old('username') }}" />
                  @error('username')
                ...
                <div class="mb-1">
                  ...
                  <input type="text" class="form-control @error('email') is-invalid @enderror" id="register-email"
                    name="email" placeholder="abdul@example.com" aria-describedby="register-email" tabindex="2"
                    value="{{ old('email') }}" />
                  @error('email')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                ...
                <div class="mb-1">
                  ...
                  <div class="input-group input-group-merge form-password-toggle">
                    <select name="role" id="role" class="select2 select form-select" value="{{ old('role') }}">
